...
<div style="width: 1200px; margin: 0 auto; font-family: 'Nanum Gothic Coding', monospace;">
	<div class="container-fluid">
			...
			<!-- 바디 로우 -->
			<div class="row mt-4" style="text-align:left;"><div class="col-auto fs-5 fw-bold"><i class="bi bi-hand-thumbs-up-fill text-danger"></i><font size=5> 추천순위</font></div></div>

			<div class="row mt-4">
			
			<c:forEach items="${recommendList }" var="recommend" begin="0" end="19">
				...
				<c:forEach items="${posterVoList }" var="poster">
					...
					<c:choose>
						<c:when test="${empty poster.poster_url }">
							...
							<a href="/movie/board/onelinereply/contentsDetails.do?movie_no=${recommend.movieLikeVo.movie_no }" style="color: black; text-decoration: none;">
