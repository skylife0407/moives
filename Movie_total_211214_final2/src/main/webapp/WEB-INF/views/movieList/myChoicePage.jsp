...
<div style="width: 1200px; margin: 0 auto; font-family: 'Nanum Gothic Coding', monospace;">
	<div class="container-fluid">
			...
			<div class="col-auto fs-5 fw-bold"><i class="bi bi-grid-1x2-fill text-danger"></i><font size=5> 선호추천장르</font></div></div>

			<div class="row mt-4">
	
			<c:forEach items="${favorList }" var="favor" begin="0" end="9">
				...
				<c:forEach items="${posterVoList }" var="poster">
					...
					<c:choose>
						<c:when test="${empty poster.poster_url }">
							...
							<a href="/movie/board/onelinereply/contentsDetails.do?movie_no=${favor.favorGenreVo.movie_no }" style="color: black; text-decoration: none;">
