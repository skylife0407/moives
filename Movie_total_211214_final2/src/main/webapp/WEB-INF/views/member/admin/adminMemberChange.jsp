				...
				<div class="col-10">
					...
					<c:choose>
						<c:when test="${sessionUser.member_auth == 1 }">
							<form action="./AdminMemberChangeProcess.do" method="post">
								아이콘 : <input name="icon_no" value="${list.icon_no }"><br> 아이디 : <input name="member_id" value="${list.member_id }" readonly="readonly"><br> 비밀번호 : <input type="password" name="member_pw"><br> 닉네임 : <input name="member_nick" value="${list.member_nick }"><br> 계정상태 : <input name="member_activity" value="${list.member_activity }"><br> 권한 : <input name="member_auth" value="${list.member_auth }"><br> <input type="hidden" name="member_no" value="${list.member_no }"> <input type="submit" value="변경">
							</form>
						</c:when>
						<c:otherwise>
