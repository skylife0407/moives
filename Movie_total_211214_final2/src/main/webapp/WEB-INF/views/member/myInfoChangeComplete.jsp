		...
		<div style="width: 1200px; margin: 0 auto;">
			<div class="container-fluid">
   				<div class="row mt-3">
					...
					<div class="row mt-3"  style="text-align:center; font-family: 'Noto Sans KR', sans-serif;">
						<div class="col">
							<h1>정보변경 완료!</h1>
						</div>
					</div>
					...
					<div class="row mt-3"  style="text-align:center;">
						<div class="col">
							<a href="/movie/member/memberInfo.do" style="color: black; text-decoration: none;">회원정보 페이지로...</a>
						</div>
					</div>
