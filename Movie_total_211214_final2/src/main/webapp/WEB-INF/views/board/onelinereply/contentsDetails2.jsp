    ...
    <head>
        ...
        google.charts.load('current', {'packages':['bar']});
            ...
            function checkingUserWrote(){
				...
				xmlhttp.open("get" , "./checkingUserWrote.do?movie_no=${map.movieVo.movie_no}" , false); 
				xmlhttp.send();		
			}
            ...
            function like() {
				...
				xmlhttp.open("get" , "./doLikeRest.do?movie_no=${map.movieVo.movie_no}"); 
				xmlhttp.send();
			}
            ...
            function refreshLikeButton(){				
				...
				xmlhttp.open("get" , "./getMyLikeData.do?movie_no=${map.movieVo.movie_no}"); 
				xmlhttp.send();
			}
            ...
            function refreshTotalLike(){
				...
				xmlhttp.open("get" , "./getTotalLikeCount.do?movie_no=${map.movieVo.movie_no}"); 
				xmlhttp.send();
			}
            ...
            function refreshAvgStar(){
				...
				xmlhttp.open("get" , "./getAvgStar.do?movie_no=${map.movieVo.movie_no}"); 
				xmlhttp.send();
			}
					...
					if(xmlhttp.readyState==4 && xmlhttp.status==200){
						...
						if(commentListLength != 0){
							...
							for(commentData of data.commentlist){
								...
								starColBox.setAttribute("class" , "col-auto border-end text-warning fw-bold");
								
								starColBox.innerText = "★ "+commentData.oneLineReplyVo.oneLineReply_star;
								
								rowBox.appendChild(starColBox);
								
								
								var contentColBox = document.createElement("div");
								contentColBox.setAttribute("class" , "col border-end");
								...
								if(sessionNo == commentData.memberVo.member_no){
									deleteColBox.setAttribute("onclick" , "deleteComment("+ commentData.oneLineReplyVo.oneLineReply_no +")");
								...
								if(sessionNo == commentData.memberVo.member_no){
									updateButtonBox.setAttribute("onclick" , "createUpdateForm(this , "+ commentData.oneLineReplyVo.oneLineReply_no +")");
            ...
            function getMyReply(){
				...
				xmlhttp.open("get" , "./getMyReply.do?movie_no=${map.movieVo.movie_no}" , false); 
				xmlhttp.send();		
			}
			...
			function createUpdateForm(e , oneLineReplyNo){
				...
				inputBox.setAttribute("cols" , "60");
				inputBox.value = myReply;
				var updateConfirmButton = document.createElement("button");
				updateConfirmButton.innerText = "수정";
				updateConfirmButton.setAttribute("class" , "btn btn-primary btn-sm");
				...
				inputOutterBox.appendChild(inputBox);
				inputOutterBox.appendChild(star);
				inputOutterBox.appendChild(updateConfirmButton);
				inputOutterBox.appendChild(updateCancelButton);
