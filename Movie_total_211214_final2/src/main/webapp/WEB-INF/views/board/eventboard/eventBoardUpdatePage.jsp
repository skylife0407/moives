		...
		<div class="container-fluid">
			<div class="row mt-3">
				...
				<div class="col-10 userInfofont">
					...
					<div class="row mt-4">
						<div class="col fs-4">
							<i class="bi bi-calendar3 text-danger"></i> 이벤트 수정
						</div>
					</div>
					<form action="/movie/board/eventboard/eventBoardUpdateProcess.do" method="post" enctype="multipart/form-data">
						<div class="row mt-4">
							<div class="col-2 pe-0">이벤트명</div>
							<div class="col ps-0">
								<input class="form-control" type="text" name="eventboard_title" value="${data.eventBoardVo.eventboard_title }">
							</div>
						</div>
						...
						<div class="row mt-3">
							...
							<div class="col ps-0">
								<textarea class="form-control" rows="10" cols="60" name="eventboard_content" >${data.eventBoardVo.eventboard_content }</textarea>
							</div>
						</div>
						...
						<div class="row mt-3">
							...
							<div class="col-auto">
								<input class="form-control" id="startdate" type="date" name="eventboard_startdate" value="<fmt:formatDate value="${data.eventBoardVo.eventboard_startdate }"  pattern="yyyy-MM-dd"/>">
							</div>
							<div class="col-auto pe-0 ms-3">종료일</div>
							<div class="col-auto">
								<input class="form-control" id="startdate" type="date" name="eventboard_enddate" value="<fmt:formatDate value="${data.eventBoardVo.eventboard_enddate }"  pattern="yyyy-MM-dd"/>">
							</div>
						</div>
						...
						<div class="row mt-5">
							<div class="col d-grid">
								<input class="btn btn-primary" type="submit" value="변경 완료">
							</div>
						</div>
					</form>
